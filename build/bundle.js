...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PageOne = __webpack_require__(12);

	var _PageOne2 = _interopRequireDefault(_PageOne);

	var _PageTwo = __webpack_require__(15);

	var _PageTwo2 = _interopRequireDefault(_PageTwo);

	var _vueStrap = __webpack_require__(18);

	var VueStrap = _interopRequireWildcard(_vueStrap);
	...
	var vm = new _vue2.default({
	    el: 'body',
	    data: {
	        pages: [{ name: 'page-one', title: 'Page One' }, { name: 'page-two', title: 'Page Two' }],
	        page: { name: 'page-one', title: 'Page One' }
	    },
	    methods: {
	        route: function route(i) {
	            this.page = this.pages[i];
	        }
	    },
	    components: {
	        'page-one': _PageOne2.default,
	        'page-two': _PageTwo2.default,
